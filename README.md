<img alt="Pengcheng Wang profile banner" src="https://github.com/ChulanZhang/ChulanZhang/blob/main/github.jpg" />

### Hi, I'm Pengcheng Wang

I'm a **Ph.D. Candidate in Purdue ECE**, expected to complete my Ph.D. in **Dec 2026**.

I build **adaptive ML systems** for efficient vision and multimodal models, with a focus on making VLM/LLM inference faster, more resource-aware, and deployable across embedded GPUs, server GPUs, and AI accelerators.

**Actively seeking full-time opportunities** as a Machine Learning Engineer or Research Scientist in ML systems, efficient inference, and AI infrastructure.
